...
for question in questions:
    ...
    print(Fore.CYAN + ">" + Style.RESET_ALL + Fore.YELLOW + question + Style.RESET_ALL)
    print() 
    
    for option in options[question_num]:
        print(Fore.CYAN + " " +  option + Style.RESET_ALL)     
        print() 
    guess = input(Fore.CYAN + ">" + Style.RESET_ALL + Fore.YELLOW + "Enter (A, B, C, D): " + Style.RESET_ALL).upper()
